    ...
    <section id="content">
      ...
      <div class="camera-wrapper">
        <div id="camera" class="camera-wrap">
          <div data-src="images/network.jpg">
            <div class="fadeIn camera_caption">
              <h2 class="text_1 color_1"><u>Network Operators</u></h2> <a class="btn_1" href="networkoperators.php">More info</a> </div>
          </div>
      ...
      <div class="container">
        <div class="row wrap_1">
          <div class="text_5">
            ...
            <?php
 $result = select_qry("select * from `network_operators`;");
?>
...
?>
       ...
       <td><b><?php echo $row['phone_number']?></td>

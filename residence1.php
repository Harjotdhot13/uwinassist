              ...
              <div class="box_2 maxheight2">
                <div class="caption">
                  ...
                  <ul style="list-style-type:disc">
                    ...
                    <li>Cartier Hall</li>
                    <li>Laurier Hall</li>
                    <li>Macdonald Hall</li>
                  </ul> <a class="btn_2" href="http://www1.uwindsor.ca/residence/">More Info On Uwindsor Website</a> </div>
            ...
            <div class="wrap_6">
              <div class="box_2 maxheight2">
                <div class="caption">
                  ...
                  <ul style="list-style-type:disc">
                    <li>www.kijiji.ca</li>
                    <li>www.rentboard.ca</li>
                    <li>www.ovlix.com</li>
                    <li>www.rent4all.com</li>
                  </ul>
                </div>
                <div class="clearfix"></div>
              </div>

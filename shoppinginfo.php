      ...
      <div class="container">
        <div class="row wrap_1">
          <div class="text_5">
            ...
            <?php
 $result = select_qry("select * from `shopping_services`;");
?>
...
?>
                  <td><b><?php  echo $row['Shoppingcenter']; ?></td>
        <td><b><?php echo $row['Address']?></td>
       <td><b><?php echo $row['Phone Number']?></td>
        <td><b><?php echo $row['Hours']?></td>
        <td><b><?php echo $row['Other Info']?></td>
        </tr>
        <?php
            }
        ?>

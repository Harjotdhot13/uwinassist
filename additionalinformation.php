    ...
    <section id="content">
      ...
      <div class="camera-wrapper">
        <div id="camera" class="camera-wrap">
          <div data-src="images/additionalinfo.jpg">
            <div class="fadeIn camera_caption">
              <h2 class="text_1 color_1"><u>Additional Information</u></h2> </div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row wrap_1">
          <div class="text_5">
            ...
            <?php
 $result = select_qry("select * from `other_information`;");
?>
...
?>
                  <tr>
                    <td><b><?php  echo $row['Name_of_service']; ?></td>
        
        <td><b><?php echo $row['Information']?></td>

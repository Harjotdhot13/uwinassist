    ...
    <section id="content">
      ...
      <div class="camera-wrapper">
        <div id="camera" class="camera-wrap">
          <div data-src="images/transportation.jpg">
            <div class="fadeIn camera_caption">
              <h2 class="text_1 color_1"><u>Transportation</u></h2> </div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row wrap_1">
          <div class="text_5">
            ...
            <?php
 $result = select_qry("select * from `transportation_service`;");
?>
...
?>
                  <td><b><?php  echo $row['Service_name']; ?></td>
